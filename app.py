...
def main():
    ...
    with tab1:
        ...
        if st.session_state['last_analise']:
            ...
            # CORREÇÃO: Verificar se há mercados selecionados antes de criar colunas
            if len(selected_markets) > 0:
                ...
                st.warning("⚠️ Nenhum mercado selecionado na sidebar. Selecione pelo menos um para visualizar as probabilidades.")
            ...
            with detail_col:
                ...
                # CORREÇÃO: Aplicar a mesma verificação aqui para a calculadora
                if len(selected_markets) > 0:
                    ...
                    st.info("Selecione mercados na sidebar para usar a calculadora de Value Bet.")
